...
/**
 * This is the base model class for table "customer_billing_address".
 *
 * @property integer $id
 ...
 */
class CustomerBillingAddress extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \thienhungho\CustomerManagement\modules\CustomerBase\query\CustomerBillingAddressQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \thienhungho\CustomerManagement\modules\CustomerBase\query\CustomerBillingAddressQuery(get_called_class());
    }
}
