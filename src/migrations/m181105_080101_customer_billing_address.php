...
class m181105_080101_customer_billing_address extends \yii\db\Migration
{
    public function safeUp()
    {
        ...
        $this->createTable('{{%customer_billing_address}}', [
            'id'          => $this->primaryKey(),
    ...
    {
        $this->dropTable('{{%customer_billing_address}}');
    }
}
